module.exports = {
  plugins: [
    "gatsby-plugin-styled-components",
    {
      ...
      options: {
        website: {
              title: "DisDroid/IQI : Vermillion Cache", // Homepage title
              titleShort: "DisDroid:vermillion", // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation
              name: "DisDroid/Vermillion", // Website name used for homescreen (PWA) and SEO
              description: "DisDroid/IQI Vermillion cache site.", // Website description used for RSS feeds/meta description tag
              ...
              url: "https://disdroid.gatsbyjs.io", // Domain of your website without the pathPrefix
              rss: "/rss.xml", // Path to the RSS file
              rssTitle: "DisDroid/IQI Vermillion cache site.", // Title of the RSS feed
	  ...
	  // User configuration
        user: {
    	      id: "DisDroid/IQI:vermillion", // Unique identifier of the user on the website. Used for OpenGraph SEO tags
              firstName: "DisDroid/IQI", // Used for SEO
              lastName: "Vermillion", // Used for SEO
              ...
              about: "DisDroid/IQI Vermillion Monitor", // User information used for the author section
